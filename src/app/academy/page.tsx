...
const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    desc: "Основные вопросы, по которым профессионалы отбирают компании. Логика, на чём бизнес заработает, — вместо хайпа.",
    points: [
  ...
  },
  {
    ...
    points: [
      "Неликвидность: срок выхода не гарантирован",
...
const BOOKS: Book[] = [
  {
    ...
    meta: "6 частей · 25 глав · 50+ схем · PDF и EPUB",
  },
  {
    slug: "razum-mashin",
    kicker: "Учебник · ИИ",
    ...
    meta: "6 частей · 40 глав · 80+ схем · PDF и EPUB",
  },
];
