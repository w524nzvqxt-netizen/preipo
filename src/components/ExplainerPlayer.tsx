...
const SCENES: Scene[] = [
  ...
  {
    caption: "Один из путей: от стартапа до биржи",
    narration:
      "Один из возможных путей компании — частные раунды и затем IPO. Компания также может остаться частной, быть приобретена или закрыться.",
    sec: 8,
    stage: 0,
    bg: 0,
  },
  {
    caption: "Срок выхода не гарантирован",
    narration:
  ...
  },
  {
    ...
    narration:
      "Но это не гарантия. IPO WeWork сорвалось в 2019 году, а банкротная процедура началась в 2023-м. Деньги в частных компаниях неликвидны, IPO может не состояться, а капитал — потеряться полностью.",
    sec: 9,
    stage: 3,
    bg: 0,
  },
  {
    ...
    narration:
      "Pre-IPO — это игра вдолгую. Пример горизонта — от трёх до семи лет, но фактический срок зависит от сделки и может продлеваться. Это инвестиция терпеливого капитала, а не быстрая спекуляция.",
    sec: 8,
    stage: 3,
    bg: 0,
  },
